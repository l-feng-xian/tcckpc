        ...
        <div class="select-table">
            <div class="select-table-r">
                <div class="select-table-r-item" v-for="item, index in topList" :key="index + 'r'">
                    <div class="select-table-r-item-icon" v-if="index === 1">{{index + 1}}</div>
                    <div class="select-table-r-item-icon icon2" v-else-if="index === 2">{{index + 1}}</div>
                    <div class="select-table-r-item-icon icon3" v-else-if="index === 3">{{index + 1}}</div>
                    <div class="select-table-r-item-icon icon4" v-else>{{index + 1}}</div>
